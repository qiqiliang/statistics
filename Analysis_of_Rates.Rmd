...
# arrange the plots to be next to each other
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/SR_OPR.pdf")
...
# arrange the plots to be next to each other
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/P1_OPR.pdf")
...
# arrange the plots to be next to each other
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/P1_5_OPR.pdf")
...
# arrange the plots to be next to each other
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/P2_OPR.pdf")
...
# arrange the plots to be next to each other
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/PI_OPR.pdf")
...
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/SPO.pdf")
spo_plot
dev.off()
```
...
# arrange the plots to be next to each other
pdf("~/Documents/Stats Project w: qiqi/statistics/plots and figures/SR_PI.pdf")
