...
# arrange the plots to be next to each other
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/SR_OPR.png")
...
# arrange the plots to be next to each other
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/P1_OPR.png")
...
# arrange the plots to be next to each other
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/P1_5_OPR.png")
...
# arrange the plots to be next to each other
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/P2_OPR.png")
...
# arrange the plots to be next to each other
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/PI_OPR.png")
...
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/SPO.png")
spo_plot
dev.off()
```
...
# arrange the plots to be next to each other
png("~/Documents/Stats Project w: qiqi/statistics/plots and figures/SR_PI.png")
